...
def get_sales_data():
    ...
    terminal, which must be a string of 6 numbers seperated by commas.\n
...
def get_last_5_entries_sales():
    """
    Collects collumns of data from the sales worksheet, collecting the last 5 entries for each 
